...
- **자동 실행**: GitHub Actions cron으로 하루 2회(KST 09:00, 18:00) 실행
...
- **자동**: 하루 2회(KST 09:00, 18:00) GitHub Actions가 자동 실행
...
- **Claude API (Haiku)**: 기사 1건 분류 ≈ $0.0003 → 하루 2회 × 10건 = 약 **월 $0.01** (10원 미만)
